...
/**
 * PostgreSQL dialect (slice 2). Differences from MySQL:
...
final readonly class PostgreSqlPlatform implements Platform
{
    ...
    public function tryAcquireLaneSql(): string
    {
        ...
        // false contention is safe but stalls; assess in slice 2.
    ...
    {
        // TODO slice 2: full DDL — JSONB, TIMESTAMP(3), index (lane, id).
        return [];
    }
}
